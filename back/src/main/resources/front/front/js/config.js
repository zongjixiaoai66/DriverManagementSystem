...
var centerMenu = [
    ...
    ,{
        name: '代驾订单',
        url: '../daijiaDingdan/list.html'
    }
    ,{
        name: '代驾订单评价',
        url: '../daijiaDingdanCommentback/list.html'
    }
    ,{
        name: '代驾订单投诉',
        url: '../daijiaDingdanTousu/list.html'
    }
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/daijiaguanli/admin/dist/index.html#/login";
