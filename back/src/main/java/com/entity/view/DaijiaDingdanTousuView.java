...
public class DaijiaDingdanTousuView extends DaijiaDingdanTousuEntity implements Serializable {
	...
	public DaijiaDingdanTousuView() {

	}

	public DaijiaDingdanTousuView(DaijiaDingdanTousuEntity daijiaDingdanTousuEntity) {
		try {
			BeanUtils.copyProperties(this, daijiaDingdanTousuEntity);
