...
|| (sessionTable == 'siji' && scope.row.sijiId ==userId)
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/daijiaguanli/upload/forumMuBan.xls"
                        >批量导入论坛数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.sijiId = el.sijiId;//---
                            forum.sijiUuidNumber = el.sijiUuidNumber;
                            forum.sijiName = el.sijiName;
                            forum.sijiPhone = el.sijiPhone;
                            forum.sijiIdNumber = el.sijiIdNumber;
                            forum.sijiPhoto = el.sijiPhoto;
                            forum.sijiEmail = el.sijiEmail;
                            forum.newMoney = el.newMoney;
                            forum.createTime = el.createTime;
