               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="司机编号" prop="sijiUuidNumber">
                       <el-input v-model="ruleForm.sijiUuidNumber"
                                 placeholder="司机编号" clearable  :readonly="ro.sijiUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="司机手机号" prop="sijiPhone">
                       <el-input v-model="ruleForm.sijiPhone"
                                 placeholder="司机手机号" clearable  :readonly="ro.sijiPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="司机身份证号" prop="sijiIdNumber">
                       <el-input v-model="ruleForm.sijiIdNumber"
                                 placeholder="司机身份证号" clearable  :readonly="ro.sijiIdNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="司机邮箱" prop="sijiEmail">
                       <el-input v-model="ruleForm.sijiEmail"
                                 placeholder="司机邮箱" clearable  :readonly="ro.sijiEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
        ...
        data() {
            return {
                ...
                ruleForm: {
                    username: '',
                    password: '',
                    sijiUuidNumber: new Date().getTime(),
                    sijiName: '',
                    sijiPhone: '',
                    sijiIdNumber: '',
                    sijiPhoto: '',
                ...
                rules: {
                   ...
                   sijiIdNumber: [
                              { required: true, message: '司机身份证号不能为空', trigger: 'blur' },
                   ...
                   sijiPhoto: [
                              { required: true, message: '司机头像不能为空', trigger: 'blur' },
                          ],
                   sexTypes: [
                   ...
                   sijiEmail: [
                              { required: true, message: '司机邮箱不能为空', trigger: 'blur' },
