<template>
    <div class="addEdit-block">
        <el-form
                ...
                >
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='daijiaDingdan'">
                    <el-form-item class="select" v-if="type!='info'"  label="代驾订单" prop="daijiaDingdanId">
                        <el-select v-model="ruleForm.daijiaDingdanId" :disabled="ro.daijiaDingdanId" filterable placeholder="请选择代驾订单" @change="daijiaDingdanChange">
                            <el-option
                                    v-for="(item,index) in daijiaDingdanOptions"
                                    v-bind:key="item.id"
                                    :label="item.daijiaDingdanUuidNumber"
                                    :value="item.id">
                            </el-option>
                        </el-select>
                    </el-form-item>
                ...
                <el-col :span="12"  v-if="sessionTable !='daijiaDingdan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="订单编号" prop="daijiaDingdanUuidNumber">
                        <el-input v-model="daijiaDingdanForm.daijiaDingdanUuidNumber"
                ...
                <el-col :span="12"  v-if="sessionTable !='daijiaDingdan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="出发位置" prop="daijiaDingdanChufaAddress">
                        <el-input v-model="daijiaDingdanForm.daijiaDingdanChufaAddress"
                                  placeholder="出发位置" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='daijiaDingdan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="前往位置" prop="daijiaDingdanQianwangAddress">
                        <el-input v-model="daijiaDingdanForm.daijiaDingdanQianwangAddress"
                                  placeholder="前往位置" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='daijiaDingdan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="车辆颜色" prop="daijiaDingdanYanse">
                        <el-input v-model="daijiaDingdanForm.daijiaDingdanYanse"
                ...
                <el-col :span="12"  v-if="sessionTable !='daijiaDingdan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="车子品牌" prop="daijiaDingdanPinpai">
                        <el-input v-model="daijiaDingdanForm.daijiaDingdanPinpai"
                                  placeholder="车子品牌" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12" v-if="sessionTable !='daijiaDingdan' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.daijiaDingdanPhoto" label="车辆照片" prop="daijiaDingdanPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (daijiaDingdanForm.daijiaDingdanPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='daijiaDingdan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="车牌号" prop="daijiaDingdanChepaihao">
                        <el-input v-model="daijiaDingdanForm.daijiaDingdanChepaihao"
                ...
                <el-col :span="12"  v-if="sessionTable !='daijiaDingdan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="联系人姓名" prop="daijiaDingdanLianxiren">
                        <el-input v-model="daijiaDingdanForm.daijiaDingdanLianxiren"
                ...
                <el-col :span="12"  v-if="sessionTable !='daijiaDingdan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="联系电话" prop="daijiaDingdanPhone">
                        <el-input v-model="daijiaDingdanForm.daijiaDingdanPhone"
                ...
                <el-col :span="12"  v-if="sessionTable !='daijiaDingdan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="出价" prop="daijiaDingdanJine">
                        <el-input v-model="daijiaDingdanForm.daijiaDingdanJine"
                                  placeholder="出价" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='daijiaDingdan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="订单状态" prop="daijiaDingdanValue">
                        <el-input v-model="daijiaDingdanForm.daijiaDingdanValue"
            ...
            <input id="daijiaDingdanId" name="daijiaDingdanId" type="hidden">
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.daijiaDingdanTousuFile" label="附件" prop="daijiaDingdanTousuFile">
                        <file-upload
                                tip="点击上传附件"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.daijiaDingdanTousuFile?$base.url+ruleForm.daijiaDingdanTousuFile:''"
                                @change="daijiaDingdanTousuFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.daijiaDingdanTousuFile" label="附件" prop="daijiaDingdanTousuFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.daijiaDingdanTousuFile"  >附件下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.daijiaDingdanTousuContent"  label="投诉内容" prop="daijiaDingdanTousuContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.daijiaDingdanTousuContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.daijiaDingdanTousuContent" label="投诉内容" prop="daijiaDingdanTousuContent">
                            <span v-html="ruleForm.daijiaDingdanTousuContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.daijiaDingdanHuifuContent"  label="回复内容" prop="daijiaDingdanHuifuContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.daijiaDingdanHuifuContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.daijiaDingdanHuifuContent" label="回复内容" prop="daijiaDingdanHuifuContent">
                            <span v-html="ruleForm.daijiaDingdanHuifuContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    daijiaDingdanId: false,
                    yonghuId: false,
                    daijiaDingdanTousuFile: false,
                    daijiaDingdanTousuContent: false,
                    insertTime: false,
                    daijiaDingdanHuifuContent: false,
                    updateTime: false,
                },
                ruleForm: {
                    daijiaDingdanId: '',
                    yonghuId: '',
                    daijiaDingdanTousuFile: '',
                    daijiaDingdanTousuContent: '',
                    insertTime: '',
                    daijiaDingdanHuifuContent: '',
                    updateTime: '',
                },
                daijiaDingdanOptions : [],
                yonghuOptions : [],
                rules: {
                   daijiaDingdanId: [
                              { required: true, message: '代驾订单不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
         ...
         this.$http({
             url: `daijiaDingdan/page?page=1&limit=100`,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
                this.daijiaDingdanOptions = data.data.list;
            }
         });
         this.$http({
        ...
        methods: {
            ...
            daijiaDingdanChange(id){
                this.$http({
                    url: `daijiaDingdan/info/`+id,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.daijiaDingdanForm = data.data;
                    }
                });
            },
            yonghuChange(id){
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `daijiaDingdanTousu/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        _this.ruleForm = data.data;
                        _this.daijiaDingdanChange(data.data.daijiaDingdanId)
                        _this.yonghuChange(data.data.yonghuId)
                        _this.ruleForm.daijiaDingdanTousuContent = _this.ruleForm.daijiaDingdanTousuContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                        _this.ruleForm.daijiaDingdanHuifuContent = _this.ruleForm.daijiaDingdanHuifuContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.daijiaDingdanTousuContent = this.ruleForm.daijiaDingdanTousuContent.replaceAll(this.$base.url,"");
                        this.ruleForm.daijiaDingdanHuifuContent = this.ruleForm.daijiaDingdanHuifuContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`daijiaDingdanTousu/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.daijiaDingdanTousuCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            daijiaDingdanTousuFileUploadChange(fileUrls){
                this.ruleForm.daijiaDingdanTousuFile = fileUrls;
                this.addEditUploadStyleChange()
            },
