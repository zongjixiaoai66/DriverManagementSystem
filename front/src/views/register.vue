    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">辽B代驾管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <!--
                            <el-form-item label="司机编号" class="input" v-if="tableName=='siji'">
                                <el-input v-model="ruleForm.sijiUuidNumber" autocomplete="off" placeholder="司机编号"  />
                           </el-form-item>
                        -->
                        <el-form-item label="司机姓名" class="input" v-if="tableName=='siji'">
                            <el-input v-model="ruleForm.sijiName" autocomplete="off" placeholder="司机姓名"  />
                        </el-form-item>
                        <el-form-item label="司机手机号" class="input" v-if="tableName=='siji'">
                            <el-input v-model="ruleForm.sijiPhone" autocomplete="off" placeholder="司机手机号"  />
                        </el-form-item>
                        <el-form-item label="司机身份证号" class="input" v-if="tableName=='siji'">
                            <el-input v-model="ruleForm.sijiIdNumber" autocomplete="off" placeholder="司机身份证号"  />
                        </el-form-item>
                        <!--
                        ...
                        -->
                        <el-form-item label="司机邮箱" class="input" v-if="tableName=='siji'">
                            <el-input v-model="ruleForm.sijiEmail" autocomplete="off" placeholder="司机邮箱"  />
                        </el-form-item>
                        <!--
                            <el-form-item label="余额" class="input" v-if="tableName=='siji'">
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            // siji 中的 司机编号 判空处理
                            // if('siji' == this.tableName && (this.ruleForm.sijiUuidNumber== null ||this.ruleForm.sijiUuidNumber== "")){
                            ...
                            if((!this.ruleForm.sijiIdNumber)&& 'siji'==this.tableName){
                            ...
                            // siji 中的 余额 判空处理
                            // if('siji' == this.tableName && (this.ruleForm.newMoney== null ||this.ruleForm.newMoney== "")){
...
<style lang="scss" scoped>
	...
	.container {
        ...
        background-image: url(/daijiaguanli/img/back-img-bg.jpg);
