<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='siji'"  label='司机编号' prop="sijiUuidNumber">
               <el-input v-model="ruleForm.sijiUuidNumber"  placeholder='司机编号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='siji'"  label='司机姓名' prop="sijiName">
               <el-input v-model="ruleForm.sijiName"  placeholder='司机姓名' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='siji'"  label='司机手机号' prop="sijiPhone">
               <el-input v-model="ruleForm.sijiPhone"  placeholder='司机手机号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='siji'"  label='司机身份证号' prop="sijiIdNumber">
               <el-input v-model="ruleForm.sijiIdNumber"  placeholder='司机身份证号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='siji'" label='司机头像' prop="sijiPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='siji'"  label='司机邮箱' prop="sijiEmail">
               <el-input v-model="ruleForm.sijiEmail"  placeholder='司机邮箱' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='siji'"  label='余额' prop="newMoney">
...
|| flag=='siji')"  label="性别" prop="sexTypes">
...
// 注册表 司机 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         if((!this.ruleForm.sijiUuidNumber)&& 'siji'==this.flag){
                             this.$message.error('司机编号不能为空');
                             return
                         }

                         if((!this.ruleForm.sijiName)&& 'siji'==this.flag){
                             this.$message.error('司机姓名不能为空');
                             return
                         }

                             if( 'siji' ==this.flag && this.ruleForm.sijiPhone&&(!isMobile(this.ruleForm.sijiPhone))){
                                 this.$message.error(`手机应输入手机格式`);
                                 return
                             }
                         if((!this.ruleForm.sijiIdNumber)&& 'siji'==this.flag){
                             this.$message.error('司机身份证号不能为空');
                             return
                         }

                         if((!this.ruleForm.sijiPhoto)&& 'siji'==this.flag){
                             this.$message.error('司机头像不能为空');
                             return
                         }

                             if( 'siji' ==this.flag && this.ruleForm.sijiEmail&&(!isEmail(this.ruleForm.sijiEmail))){
